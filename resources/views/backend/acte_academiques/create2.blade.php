    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="white-box">
            <div class="d-md-flex mb-3">
                <h3 class="box-title mb-0">{{ __('Créer les actes académiques du procès verbal : ') }}     <span style="color: red">{{$pv->reference}}</span></h3>
                <div class="">
            ...
            <div class="">
                <form method="post" action="{{ route('proces_verbaux.provisoires.store2') }}">
                    ...
                    <div class="form-group row py-2">
                        ...
                        <div class="col">
                            <input type="text" class="form-control form-control" id="infos" name="infos" value="{{ $pv->parcours->filiere->institution->denomination }} | {{ $pv->parcours->filiere->intitule }} | {{ $pv->parcours->intitule }} | {{ $pv->parcours->niveauEtude->intitule}}"  disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row py-2">
                        ...
                        <div class="col">
                            <input type="text" class="form-control form-control" id="signataire" name="signataire" value="{{ $signataireActe ? $signataireActe->signataire->nom.' '.$signataireActe->signataire->prenom : 'Pas de signataire associé' }}"  disabled required>
                        </div>
                    </div>
