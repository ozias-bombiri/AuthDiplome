...
@section('page-title')
{{ __('Ajouter une catégorie d\'acte') }}
@endsection
    ...
    <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="white-box">
            <div class="d-md-flex mb-3">
                <h3 class="box-title mb-0">{{ __('Ajouter une catégorie d\'acte') }}</h3>
                <div class="">
            ...
            <div class="">
                <form method="post" action="{{ route('categorie_actes.store') }}">
                    ...
                    <div class="form-group row py-2">
                        ...
                        <div class="col">
                            <input type="number" class="form-control form-control" id="nombreCopies" name="nombreCopies" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row py-2">
                        ...
                        <div class="col">
                            <input type="radio" value="1" id="soutenance" name="visas"> Oui <br>
                            <input type="radio" value="0" id="soutenance" name="visas"> Non
                        </div>
                    </div>
