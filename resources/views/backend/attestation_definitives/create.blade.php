...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header">{{ __('Ajouter une attestation définitive') }}</div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <form method="post" action="{{ route('annee_academiques.store') }}">
                        ...
                        <div class="form-group row py-2">
                            <label for="debut" class="col-sm-2 col-form-label"></label>
                            <div class="col">
                        ...
                        <input type="hidden"  id="resultat" name="resultat" value="1">
                        <input type="hidden" id="signataire" name="signataire" value="1">
                    </form>
