                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('metiers.daoi.etudiantattdef-store') }}">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col">
                                <input type="number" class="form-control form-control" id="annee" name="annee" disabled>
                            </div>
                        </div>
                        <div class="row py-4">
...
<div class="row my-3">
    ...
    <div class="modal fade" id="exampleModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="exampleModalLabel">Ajouter une attestation definitive</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <form method="post" action="{{ route('metiers.daoi.attestationdef-store') }}">
                            ...
                            <fieldset class="border border-secondary px-4 py-3 my-2">
                                ...
                                <div class="form-group row py-2">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control form-control" value="" id="identifiant" disabled>
                                ...
                                <div class="form-group row py-2">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control" id="nom" value="" name="nom" readonly>
                                    </div>
                                </div>

                                <div class="col">
                                    <input type="hidden" class="form-control" id="prenom2" value="" name="prenom" readonly>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="border border-secondary px-4 py-4 my-2">
                                ...
                                <div class="form-group row py-2">
                                    ...
                                    <div class="col">
                                        <input  class="form-control form-control" id="annee2" value="" name="annee_id" readonly>
                                ...
                                <div class="form-group row py-2">
                                    ...
                                    <div class="col">
                                        <input  class="form-control form-control" id="parcours2" value="" name="parcours_id" readonly>
                                ...
                                <div class="form-group row py-2">
                                    ...
                                    <div class="col">
                                        <input  class="form-control form-control" id="sessionr" value="" name="sessionr" readonly>
                                ...
                                <div class="form-group row py-2">
                                    ...
                                    <div class="col">
                                        <input  class="form-control form-control" id="dateSoutenance" value="" name="dateSoutenance" readonly>
                                    </div>
                                </div>
                                <div class="form-group row py-2">
                                    <label for="lieuNaissance" class="col-sm-2 col-form-label">Moyenne</label>
                                    <div class="col">
                                        <input type="number" step="0.01" class="form-control form-control" id="moyenne" name="moyenne" value="" readonly>
                                    </div>
                                </div>
                                <div class="form-group row py-2">
                                    <label for="cote" class="col-sm-2 col-form-label">Côte</label>
                                    <div class="col">
                                        <input type="text" class="form-control form-control" value="" id="cote" name="cote" readonly>
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="border border-secondary px-4 py-4 my-2">
                                ...
                                <div class="col">
                                    <input type="hidden" class="form-control form-control" id="reference2" name="reference" required>
                                </div>
                            </fieldset>
...
<script type="module" src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js"></>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.add', function() {
            ...
            $.ajax({
                ...
                url: "/d/definitives/add/" + institution_id + "/" + id,
                method: "GET",
                dataType: "json",
                ...
                success: function(data) {
                    ...
                    $("#annee2").val(data.result.etudiant.annee_academique.intitule);
                    $("#parcours2").val(data.result.etudiant.parcours.intitule);
                    $("#sessionr").val(data.result.etudiant.session);
                    $("#dateSoutenance").val(data.result.etudiant.dateSoutenance);
                    $("#moyenne").val(data.result.etudiant.moyenne);
                    $("#cote").val(data.result.etudiant.cote);

                    $("#reference2").val(data.result.etudiant.reference);
                   // $("#signatureId").val(data.result.signataires.id);
